import {
  ...
  UpdateUserPayload,
  VerifyOtpPayload,
} from '../interface/rabbit_pattern.interface';
import { RABBITMQ_QUEUE } from './rabbitmq.queue';
import { definePattern } from '../../common/helper/rabbit.pattern.helper';
...
export const RABBIT_PATTERN = {
  USER: {
    ...
    UPDATE_USER_BY_ID: definePattern<UpdateUserPayload, UserDto>()({
    ...
    GET_INFO_USER: definePattern<string, UserDto | null>()({
  ...
  AUTH: {
    TEST: definePattern<RegisterUserPayload, UserDto>()({
